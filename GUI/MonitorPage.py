...
class MonitorPage(tk.Frame):
    ...
    def create_page_frame(self):
        ...
        self.label = tk.Label(
            page_frame, text='Long-term Monitor of wulalabulala')
        self.label.pack()
    ...
    def create_matplotlib(self):
        ...
        self.figure = plt.figure(num=2, figsize=(
            7, 7), dpi=80, facecolor="white", edgecolor='green', frameon=True)
        # self.figure.text(0.45, 0.94, 'wulalabulala')

        plt.bar(range(len(JOY)), JOY, label='Joy',
                facecolor='darkorange', width=0.8)
        plt.bar(range(len(JOY)), ANGER, bottom=JOY,
                label='Anger', facecolor='gray', width=0.8)
        plt.bar(range(len(JOY)), SADNESS, bottom=JOY+ANGER,
                label='Sadness', facecolor='blue', width=0.8)
        plt.bar(range(len(JOY)), FRIGHT, bottom=JOY+ANGER+SADNESS,
                label='Fright', facecolor='yellowgreen', width=0.8)
        plt.bar(range(len(JOY)), FEAR, bottom=JOY+ANGER+SADNESS +
                FRIGHT, label='Fear', facecolor='orchid', width=0.8)
        plt.bar(range(len(JOY)), LOVE, bottom=JOY+ANGER+SADNESS +
                FRIGHT+FEAR, label='Love', facecolor='pink', width=0.8)
